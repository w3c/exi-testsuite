 ...
 */
/*
 * $Id: ToStream.java,v 1.1 2010/05/07 01:12:06 tkamiya Exp $
 */
        ...
        try
        {
            ...
            for (; i < end; i++)
            {
                ...
                if (m_charInfo.shouldMapTextChar(ch)) {
                    ...
                    if (Character.isHighSurrogate(ch) && i + 1 < end && Character.isLowSurrogate(chars[i + 1])) {
                      writeOutCleanChars(chars, i, lastDirtyCharProcessed);
                      char low = chars[++i];
                      int character = Character.toCodePoint(ch, low);
                      writer.write("&#x");
                      writer.write(Integer.toString(character, 16).toUpperCase());
                      writer.write(';');
                      lastDirtyCharProcessed = i;
                    }
